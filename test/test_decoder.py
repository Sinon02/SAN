...
def test_forward(params, test_data):
    ...
    paddle_image_feaures = paddle_model.encoder(test_paddle_data[0])
    paddle_model.decoder(paddle_image_feaures, test_paddle_data[2], test_paddle_data[1], test_paddle_data[3], reprod_logger, False)
    ...
    torch_image_feaures = torch_model.encoder(test_torch_data[0])
    torch_model.decoder(torch_image_feaures, test_torch_data[2], test_torch_data[1], test_torch_data[3], reprod_logger, False)
